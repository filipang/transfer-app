          ...
          this.setLocalAndSendMessage_ = function (session_description) {
              ...
              $.ajax({
                    ...
                    success:function(responseJSON){
                        ...
                        copyLink.setAttribute('data-clipboard-text', 'http://' + window.location.hostname + '/live_transfer_download/' + responseJSON.session_id);
                        downloadLink.textContent = 'http://' + window.location.hostname + '/live_transfer_download/' + responseJSON.session_id;
